...
from TutorApp.examination_tasks.choices import GradeChoices, SubjectChoices
...
class DailyStudy(models.Model):
    plan = models.ForeignKey(
        StudyPlan, on_delete=models.CASCADE, related_name="daily_records"
    )
...
class ScheduledTask(models.Model):
    daily = models.ForeignKey(
        DailyStudy, on_delete=models.CASCADE, related_name="tasks"
    )
    task = models.ForeignKey("examination_tasks.ExamTask", on_delete=models.CASCADE)
